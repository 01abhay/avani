...
export type ProductDescriptionEmbeddingRowInsert =
  typeof productDescriptionEmbeddings.$inferInsert;
export type ProductDescriptionEmbeddingRowSelect =
  typeof productDescriptionEmbeddings.$inferSelect;
